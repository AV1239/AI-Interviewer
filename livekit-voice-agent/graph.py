...
def create_workflow():
    ...
    print(f"API KEY FOUND: {os.getenv('OPENAI_API_KEY') is not None}")
    print(f"Chroma Directory: {os.getenv('CHROMA_DIR')}")
    print("------------------------")
    ...
    def company_info_tool(query: str) -> str:
        """Searches the company information document and returns relevant chunks about the company based on the question that was asked."""
    ...
    def call_llm(state: InterviewState) -> InterviewState:
        ...
        system_prompt = (
            ...
            "1. First: 'Hello, my name is Shelby! I will be conducting your interview today. Let's start with the basics - could you tell me about yourself? Please share your background, what you're passionate about, and what brings you here today.'\n"
            ...
            "- When the candidate gives answers to your interview questions, use the record_answer_tool to record their response, then acknowledge it but do not say it was recorded and ask the next question\n"
            "- Be conversational, professional, and helpful\n"
            "- If you don't have specific company information, say so honestly and offer to connect them with someone who might know more after the interview"
        )
